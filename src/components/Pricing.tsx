...
const pricingList: PricingProps[] = [
  {
    ...
    price: 0,
    description:
      "Chose this plan if you are just starting out and want to test the app.",
  ...
  },
  {
    ...
    price: 500,
    description:
      " You are a small team and want to grow your business with us.",
    buttonText: "Buy Now",
    benefitList: [
      "4 Team member",
      "4 GB Storage",
  ...
  },
  {
    ...
    price: 3000,
    description:
      "Upgrade to the enterprise plan if you are a large team and want to scale.",
    buttonText: "Buy Now",
    benefitList: [
      "10 Team member",
      "8 GB Storage",
  ...
  return (
    <section id="pricing" className="container py-24 sm:py-32">
      ...
      <h3 className="text-xl text-center text-muted-foreground pt-4 pb-8">
        Choose the plan that works best for you. All plans include a 7-day free
      </h3>
